// $Id: instruction.h,v 1.24 2023/11/12 13:12:34 leavens Exp $
...
typedef enum {REG_O = 0, ADDI_O = 9, ANDI_O = 12, BORI_O = 13, XORI_O = 14,
	      ...
	      BNE_O = 5, BFEQ_O = 20, BFGEZ_O = 17, BFGTZ_O = 23, BFLEZ_O = 22,
	      BFLTZ_O = 24, BFNE_O = 21, LBU_O = 36, LW_O = 35, FLW_O = 41,
	      SB_O = 40, SW_O = 43, FSW_O = 42, JMP_O = 2, JAL_O = 3
} op_code;

// function codes in binary instructions for the SRM (when opcode is 0)
typedef enum {ADD_F = 33, FADD_F = 49, SUB_F = 35, FSUB_F = 51,
	      MUL_F = 25, FMUL_F = 41, DIV_F = 27, FDIV_F = 43,
	      MFHI_F = 16, MFLO_F = 18, AND_F = 36, BOR_F = 37,
	      NOR_F = 39, XOR_F = 38, SLL_F = 0, SRL_F = 3, CVT_F = 4,
	      RND_F = 5, JR_F = 8, SYSCALL_F = 12
} func_code;
...
typedef enum {exit_sc = 10, print_str_sc = 4, print_int_sc = 5,
	      print_float_sc = 6, print_char_sc = 11,
	      read_char_sc = 12, read_float_sc = 13,
