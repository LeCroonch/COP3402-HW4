// $Id: machine_types.h,v 1.10 2023/11/04 18:52:33 leavens Exp $
...
// type of 32 bit integers (word-sized ints)
typedef int int_type;

// type of 32 bit floating point numbers (word-sized floats)
