/* $Id: lexer.c,v 1.16 2023/11/12 04:57:27 leavens Exp $ */
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
#include <assert.h>
...
op_code lexer_token2opcode(int toknum)
{
    ...
    case faddopsym: case fsubopsym: case fmulopsym: case fdivopsym:
    case mfhiopsym: case mfloopsym:
    case andopsym: case boropsym: case noropsym: case xoropsym:
    case sllopsym: case srlopsym: case cvtopsym: case rndopsym:
    case jropsym:
	ret = REG_O; // distinguished by func field
	break;
    // system call op codes
    case exitopsym: case pstropsym: case pintopsym: case pfltopsym:
    case pchopsym: case rfltopsym: case straopsym: case notropsym:
...
func_code lexer_token2func(int toknum)
{
    ...
    case rfltopsym: case straopsym: case notropsym:
	ret = SYSCALL_F;
	break;
    default:
