// $Id: pass1.h,v 1.3 2023/11/06 09:36:24 leavens Exp $
#ifndef _PASS1_H
#define _PASS1_H
#include <stdio.h>
#include "ast.h"
...
// Check the given AST and put its declarations in the symbol table
extern void pass1StaticIntDecls(static_int_decls_t sids);

// Check the given AST and put its declarations in the symbol table
extern void pass1StaticFloatDecls(static_float_decls_t sids);

// Check the given AST and put its declaration in the symbol table
extern void pass1StaticIntDecl(static_int_decl_t dcl, address_type offset);

// Check the given AST and put its declaration in the symbol table
extern void pass1StaticFloatDecl(static_float_decl_t dcl, address_type offset);

// Check the given AST and put its declarations in the symbol table
extern void pass1Ident(ident_t id, id_attr_kind iak, address_type offset);
