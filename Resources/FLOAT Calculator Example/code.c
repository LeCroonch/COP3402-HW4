/* $Id: code.c,v 1.20 2023/11/28 03:36:34 leavens Exp $ */
#include <stdlib.h>
#include "utilities.h"
#include "code.h"
#include "regname.h"
...
// with the given mnemonic and parameters
// Modifies when executed: register rd
code *code_fadd(reg_num_type rs, reg_num_type rt, reg_num_type rd)
{
    return create_reg_instr(rs, rt, rd, 0, FADD_F);
}
...
// with the given mnemonic and parameters
// Modifies when executed: register rd
code *code_fsub(reg_num_type rs, reg_num_type rt, reg_num_type rd)
{
    return create_reg_instr(rs, rt, rd, 0, FSUB_F);
}
...
// with the given mnemonic and parameters
// Modifies when executed: register rd
code *code_fmul(reg_num_type rs, reg_num_type rt, reg_num_type rd)
{
    return create_reg_instr(rs, rt, rd, 0, FMUL_F);
}
...
// with the given mnemonic and parameters
// Modifies when executed: register rd
code *code_fdiv(reg_num_type rs, reg_num_type rt, reg_num_type rd)
{
    return create_reg_instr(rs, rt, rd, 0, FDIV_F);
}
...
// with the given mnemonic and parameters
// Modifies when executed: register rd
code *code_cvt(reg_num_type rt, reg_num_type rd)
{
    return create_reg_instr(0, rt, rd, 0, CVT_F);
}

// Create and return a fresh instruction
// with the given mnemonic and parameters
// Modifies when executed: register rd
code *code_rnd(reg_num_type rt, reg_num_type rd)
{
    return create_reg_instr(0, rt, rd, 0, RND_F);
}
...
// with the given mnemonic and parameters
// Modifies when executed: PC
code *code_bfeq(reg_num_type rs, reg_num_type rt, immediate_type o)
{
    return create_immed_instr(BFEQ_O, rs, rt, o);
}

// Create and return a fresh instruction
// with the given mnemonic and parameters
// Modifies when executed: PC
code *code_bfgez(reg_num_type rs, immediate_type o)
{
    return create_immed_instr(BFGEZ_O, rs, 1, o);
}

// Create and return a fresh instruction
// with the given mnemonic and parameters
// Modifies when executed: PC
code *code_bfgtz(reg_num_type rs, immediate_type o)
{
    return create_immed_instr(BFGTZ_O, rs, 0, o);
}

// Create and return a fresh instruction
// with the given mnemonic and parameters
// Modifies when executed: PC
code *code_bflez(reg_num_type rs, immediate_type o)
{
    return create_immed_instr(BFLEZ_O, rs, 0, o);
}

// Create and return a fresh instruction
// with the given mnemonic and parameters
// Modifies when executed: PC
code *code_bfltz(reg_num_type rs, immediate_type o)
{
    return create_immed_instr(BFLTZ_O, rs, 0, o);
}

// Create and return a fresh instruction
// with the given mnemonic and parameters
// Modifies when executed: PC
code *code_bfne(reg_num_type rs, reg_num_type rt, immediate_type o)
{
    return create_immed_instr(BFNE_O, rs, rt, o);
}
...
// with the given mnemonic and parameters
// Modifies when executed: register rt
code *code_flw(reg_num_type rb, reg_num_type rt, immediate_type o)
{
    return create_immed_instr(FLW_O, rb, rt, o);
}
...
// with the given mnemonic and parameters
// Modifies when executed: memory[GPR.ints[rb]+formOffset(o)]
code *code_fsw(reg_num_type rb, reg_num_type rt, immediate_type o)
{
    return create_immed_instr(FSW_O, rb, rt, o);
}
...
code *code_pflt()
{
    return create_syscall_instr(print_float_sc);
}
...
// assuming that reg holds a value of type t.
// Modifies SP and memory.words[SP-BYTES_PER_WORD] when executed
code_seq code_push_reg_on_stack(reg_num_type reg, type_exp_e t)
{
    code_seq ret = code_allocate_stack_space(BYTES_PER_WORD);
    if (t == float_te) {
	ret = code_seq_add_to_end(ret, code_fsw(SP, reg, 0));
    } else {
...
code_seq code_pop_stack_into_reg(reg_num_type reg, type_exp_e t)
{
    code_seq ret;
    if (t == float_te) {
