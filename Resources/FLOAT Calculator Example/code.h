/* $Id: code.h,v 1.18 2023/11/28 03:36:34 leavens Exp $ */
#ifndef _CODE_H
#define _CODE_H
#include <stdbool.h>
...
// FLOAT SRM assembly language instructions (that can be in linked lists)
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_fadd(reg_num_type rs, reg_num_type rt, reg_num_type rd);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_fsub(reg_num_type rs, reg_num_type rt, reg_num_type rd);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_fmul(reg_num_type rs, reg_num_type rt, reg_num_type rd);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_fdiv(reg_num_type rs, reg_num_type rt, reg_num_type rd);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_cvt(reg_num_type rt, reg_num_type rd);

// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_rnd(reg_num_type rt, reg_num_type rd);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_bfeq(reg_num_type rs, reg_num_type rt, immediate_type o);

// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_bfgez(reg_num_type rs, immediate_type o);

// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_bfgtz(reg_num_type rs, immediate_type o);

// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_bflez(reg_num_type rs, immediate_type o);

// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_bfltz(reg_num_type rs, immediate_type o);

// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_bfne(reg_num_type rs, reg_num_type rt, immediate_type o);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_flw(reg_num_type rb, reg_num_type rt, immediate_type o);
...
// Create and return a fresh instruction
// with the given mnemonic and parameters
extern code *code_fsw(reg_num_type rb, reg_num_type rt, immediate_type o);
...
// Modifies SP and memory[SP-BYTES_PER_WORD] when executed
extern code_seq code_push_reg_on_stack(reg_num_type reg, type_exp_e t);
...
// Modifies SP and GPR[reg] when executed
extern code_seq code_pop_stack_into_reg(reg_num_type reg, type_exp_e t);
